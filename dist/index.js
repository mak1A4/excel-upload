...
var _tmpl$2 = /* @__PURE__ */ template(`<div class=excel-upload-component><div class="p-6 max-w-md mx-auto bg-white rounded-xl shadow-md"><div class="flex items-center justify-center mb-4"><h2></h2></div><div class=space-y-4><div><p class="text-sm font-medium text-gray-700 mb-1"></p><p class="text-xs text-gray-500 mb-3"></p><input type=file accept=".xlsx, .xls"class=hidden id=file-upload><label for=file-upload>`);
var _tmpl$22 = /* @__PURE__ */ template(`<div class=space-y-3><div><span class=font-medium></span> </div><button>`);
var _tmpl$3 = /* @__PURE__ */ template(`<div><div class="flex items-center mb-2"><span class=font-medium>Verification Issues:</span></div><ul class="list-disc pl-5 space-y-1">`);
var _tmpl$4 = /* @__PURE__ */ template(`<li>`);
var _tmpl$5 = /* @__PURE__ */ template(`<div><span class=font-medium>File verified successfully`);
function ExcelUploadComponent(props = {}) {
  ...
  return (() => {
    var _el$ = _tmpl$2(), _el$2 = _el$.firstChild, _el$3 = _el$2.firstChild, _el$4 = _el$3.firstChild, _el$5 = _el$3.nextSibling, _el$6 = _el$5.firstChild, _el$7 = _el$6.firstChild, _el$8 = _el$7.nextSibling, _el$9 = _el$8.nextSibling, _el$0 = _el$9.nextSibling;
    var _ref$ = containerRef;
    typeof _ref$ === "function" ? use(_ref$, _el$) : containerRef = _el$;
    insert(_el$3, createComponent(FileSpreadsheet, {
      get ["class"]() {
        return `h-6 w-6 ${primaryColor()} mr-2`;
      }
    }), _el$4);
    insert(_el$4, title);
    ...
    _el$6.addEventListener("dragenter", handleDragEnter);
    insert(_el$6, createComponent(Upload, {
      get ["class"]() {
        return `h-12 w-12 ${primaryColor()} mb-2`;
      }
    }), _el$7);
    insert(_el$7, dragDropText);
    insert(_el$8, orText);
    _el$9.addEventListener("change", handleFileChange);
    var _ref$2 = fileInputRef;
    typeof _ref$2 === "function" ? use(_ref$2, _el$9) : fileInputRef = _el$9;
    insert(_el$0, selectButtonText);
    insert(_el$5, (() => {
      var _c$ = memo(() => !!fileName());
      return () => _c$() && (() => {
        var _el$1 = _tmpl$22(), _el$10 = _el$1.firstChild, _el$11 = _el$10.firstChild, _el$12 = _el$11.nextSibling, _el$13 = _el$10.nextSibling;
        insert(_el$10, createComponent(Check, {
          get ["class"]() {
            return `h-5 w-5 mr-2 ${successIconColor()}`;
          }
        }), _el$11);
        insert(_el$11, fileSelectedText);
        insert(_el$10, fileName, null);
        insert(_el$1, (() => {
          var _c$2 = memo(() => verificationErrors().length > 0);
          return () => _c$2() && (() => {
            var _el$14 = _tmpl$3(), _el$15 = _el$14.firstChild, _el$16 = _el$15.firstChild, _el$17 = _el$15.nextSibling;
            insert(_el$15, createComponent(TriangleAlert, {
              "class": "h-5 w-5 mr-2"
            }), _el$16);
            ...
            createRenderEffect(() => className(_el$14, `p-3 ${errorBgColor} ${errorColor()} rounded-md text-sm`));
            return _el$14;
          })();
        })(), _el$13);
        insert(_el$1, (() => {
          var _c$3 = memo(() => !!isVerified());
          return () => _c$3() && (() => {
            var _el$19 = _tmpl$5(), _el$20 = _el$19.firstChild;
            insert(_el$19, createComponent(Check, {
              get ["class"]() {
                return `h-5 w-5 mr-2 ${successIconColor()}`;
              }
            }), _el$20);
            createRenderEffect(() => className(_el$19, `p-3 ${successBgColor()} ${successColor()} rounded-md text-sm flex items-center`));
            return _el$19;
          })();
        })(), _el$13);
        _el$13.$$click = handleUpload;
        insert(_el$13, createComponent(FileCheck, {
          "class": "h-5 w-5 mr-2"
        }), null);
        insert(_el$13, (() => {
          var _c$4 = memo(() => !!isVerifying());
          return () => _c$4() ? "Verifying..." : uploadButtonText();
        })(), null);
        createRenderEffect((_p$) => {
          var _v$4 = `p-3 ${successBgColor()} ${successColor()} rounded-md text-sm flex items-center`, _v$5 = isVerifying(), _v$6 = `w-full py-2 px-4 flex items-center justify-center text-sm font-medium text-white 
    ...
    createRenderEffect((_p$) => {
      var _v$ = `text-xl font-bold ${primaryColor()}`, _v$2 = `border-2 border-dashed rounded-lg p-6 flex flex-col items-center justify-center text-center ${isDragging() ? `${dragBorderColor()} ${dragBgColor()}` : "border-gray-300"}`, _v$3 = `py-2 px-4 text-sm font-medium text-white ${primaryBgColor()} rounded-md hover:${hoverBgColor()} cursor-pointer`;
...
customElement("excel-upload", {}, (props) => {
  return ExcelUploadComponent({ ...props, styles: styles_default });
});
export {
