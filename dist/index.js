...
var _tmpl$3 = /* @__PURE__ */ template(`<div class=space-y-3><div><span class=font-medium></span> `);
...
var _tmpl$8 = /* @__PURE__ */ template(`<div class="excel-upload-component flex justify-center items-center"><div class="p-8 max-w-lg w-full bg-white rounded-2xl drop-shadow-2xl border border-green-200"><div class=space-y-4>`);
...
function ExcelUploadComponent(props = {}) {
  ...
  const renderFileStatus = () => fileName() && (() => {
    ...
    insert(_el$8, (() => {
      ...
      return () => _c$() && (() => {
        var _el$10 = _tmpl$4(), _el$11 = _el$10.firstChild, _el$12 = _el$11.firstChild, _el$13 = _el$11.nextSibling;
        insert(_el$11, createComponent(TriangleAlert, {
          "class": "h-5 w-5 mr-2"
        }), _el$12);
        ...
        createRenderEffect(() => className(_el$10, `p-3 ${colors.errorBgColor} ${colors.errorColor()} rounded-md text-sm`));
        return _el$10;
      })();
    })(), null);
    insert(_el$8, (() => {
      ...
      return () => _c$2() && (() => {
        ...
        insert(_el$15, createComponent(FileCheck, {
          get ["class"]() {
            return `h-5 w-5 mr-2 ${colors.successIconColor()}`;
          }
        }), _el$16);
        createRenderEffect(() => className(_el$15, `p-3 ${colors.successBgColor()} ${colors.successColor()} rounded-md text-sm flex items-center`));
        return _el$15;
      })();
    })(), null);
    insert(_el$8, (() => {
      ...
      return () => _c$3() && (() => {
        var _el$17 = _tmpl$7();
        _el$17.$$click = verifyFile;
        insert(_el$17, createComponent(Check, {
          "class": "h-5 w-5 mr-2"
        }), null);
        insert(_el$17, (() => {
          var _c$5 = memo(() => !!isVerifying());
          return () => _c$5() ? "Verifying..." : getTextHelpers(props).verifyButtonText();
        })(), null);
        createRenderEffect((_p$) => {
          var _v$3 = isVerifying(), _v$4 = `w-full py-2 px-4 flex items-center justify-center text-sm font-medium text-white 
            ${isVerifying() ? "bg-gray-400" : colors.primaryBgColor()} 
            rounded-md 
            ${isVerifying() ? "" : `hover:${colors.hoverBgColor()}`} 
            transition-colors duration-200
            cursor-pointer`;
          _v$3 !== _p$.e && (_el$17.disabled = _p$.e = _v$3);
    ...
    insert(_el$8, (() => {
      var _c$4 = memo(() => !!isVerified());
      return () => _c$4() && (() => {
        var _el$18 = _tmpl$7();
        _el$18.$$click = handleUpload;
        insert(_el$18, createComponent(Upload, {
          "class": "h-5 w-5 mr-2"
        }), null);
        insert(_el$18, () => getTextHelpers(props).uploadButtonText(), null);
        createRenderEffect(() => className(_el$18, `w-full py-2 px-4 flex items-center justify-center text-sm font-medium text-white 
    ...
    createRenderEffect(() => className(_el$9, `p-3 ${colors.successBgColor()} ${colors.successColor()} rounded-md text-sm flex items-center`));
    return _el$8;
  })();
  return (() => {
    var _el$19 = _tmpl$8(), _el$20 = _el$19.firstChild, _el$21 = _el$20.firstChild;
    var _ref$2 = containerRef;
    typeof _ref$2 === "function" ? use(_ref$2, _el$19) : containerRef = _el$19;
    insert(_el$21, renderHeader, null);
    insert(_el$21, renderDragArea, null);
    insert(_el$21, renderFileStatus, null);
    return _el$19;
  })();
}
